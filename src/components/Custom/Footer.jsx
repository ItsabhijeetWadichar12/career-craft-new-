...
function Footer() {
  return (
    <div>
    <footer className='bg-white mt-0 mb-0'>
      <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-10 sm:px-6 lg:px-8 lg:pt-24">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <div className=''>
             <img src="/public/career-craft-high-resolution-logo-black-transparent.png" alt="logo no"  width={150} height={150}/>
            </div>
            ...
            <div className="text-center sm:text-left">
              ...
              <ul className="mt-8 space-y-4 text-sm">
                <li>
                    ...
                    <Link to={'/faqs'} className="text-gray-700 transition hover:text-gray-700/75 dark:text-white dark:hover:text-white/75">
                     FAQs
                    </Link>
                  <a
              ...
              <ul className="mt-8 space-y-4 text-sm">
                ...
                <li>
                  ...
                  >
                    ...
                    <span className="flex-1 text-gray-700 dark:text-gray-300">+91 7820817801 </span>
                  </a>
                </li>
